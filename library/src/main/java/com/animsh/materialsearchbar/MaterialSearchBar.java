package com.animsh.materialsearchbar;
...
import com.animsh.materialsearchbar.adapter.DefaultSuggestionsAdapter;
import com.animsh.materialsearchbar.adapter.SuggestionsAdapter;
...
/**
 * Created by animsh on 12/28/2020.
 */
public class MaterialSearchBar extends FrameLayout implements View.OnClickListener,
    ...
    private void animateSuggestions(int from, int to) {
        ...
        Log.d(TAG, "animateSuggestions: " + lp.height);
    ...
    public void onAnimationEnd(Animation animation) {
        if (!searchOpened) {
            ...
            searchEdit.setText("");
            final RecyclerView suggestionsList = findViewById(R.id.mt_recycler);
            if (suggestionsList.getChildCount() == 0) {
                animateSuggestions(getListHeight(false), 0);
            }
            Log.d(TAG, "onAnimationEnd: " + suggestionsList.getChildCount());
        } else {
    ...
    private static class SavedState extends BaseSavedState implements Serializable {
